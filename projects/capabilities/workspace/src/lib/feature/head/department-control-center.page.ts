...
import { AccessService, SessionStore, WorkspaceContext } from '@backoffice/domain';
import { WidgetHost } from '@backoffice/shell';
import { Badge, Card, EmptyState, Icon, PageHeader } from '@backoffice/ui-kit';
