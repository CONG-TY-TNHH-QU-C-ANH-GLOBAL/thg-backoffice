...
import {
  ...
  departmentGuard,
  superadminGuard,
} from '@backoffice/shell';
import { workspaceCapabilities } from '@backoffice/capability-workspace';
import { worklistCapabilities } from '@backoffice/capability-worklist';
import { potentialCustomerCapabilities } from '@thg/capability-potential-customers';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'my-work',
        loadComponent: () => import('@backoffice/capability-worklist').then((m) => m.MyWorkPage),
...

      {
        ...
        loadComponent: () =>
          import('@backoffice/capability-workspace').then((m) => m.DepartmentsPage),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('@backoffice/capability-workspace').then((m) => m.DepartmentWorkspacePage),
        children: [
